...
import { isInsideRectangle } from './utils/utils'
...
class LGraphNode {
  ...
  */
  ...
  findInputSlotFree(optsIn) {
    var optsIn = optsIn || {}
    const optsDef = { returnObj: false, typesNotAccepted: [] }
  ...
  connectByType(slot, target_node, target_slotType, optsIn) {
    var optsIn = optsIn || {}
    const optsDef = { createEventInCase: true, firstFreeIfOutputGeneralInCase: true, generalTypeInCase: true }
    const opts = Object.assign(optsDef, optsIn)
  ...
  connectByTypeOutput(slot, source_node, source_slotType, optsIn) {
    var optsIn = optsIn || {}
    const optsDef = { createEventInCase: true, firstFreeIfInputGeneralInCase: true, generalTypeInCase: true }
    const opts = Object.assign(optsDef, optsIn)
